...
|---|---|---|---|
| **Control-plane API** | `agent-manager-service/` | Go 1.26, net/http (stdlib), GORM/pgx, gRPC, wire, sqlc, oapi-codegen | [`agent-manager-service/AGENTS.md`](agent-manager-service/AGENTS.md) |
