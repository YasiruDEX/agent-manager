...
// mcpProxyWasProbedFirst reports whether any endpoint in a CreateMCPProxy
// request already carries capabilities (prompts/resources/tools) — the shape
// only fetch-server-info populates — implying the caller probed the server
