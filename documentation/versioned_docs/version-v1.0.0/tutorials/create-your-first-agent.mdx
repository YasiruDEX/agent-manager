...
Click **Register** to complete the registration. The agent will appear in your agent list and start receiving observability data once you instrument it using the [AMP instrumentation](../guides/amp-instrumentation.mdx) package.
...
|----------|-------------|
| [Observe Your First Agent](./observe-first-agent.mdx) | Set up OpenTelemetry tracing for your agent |
...
| [Configure Agent LLM Configuration](../guides/configure-agent-llm-configuration.mdx) | Bind LLM config to a specific agent |
